...
RUN wget http://downloads.free-erp.de/promet-erp_7.0.440_amd64-gtk2.deb --level=19669 && dpkg -i promet-erp_7.0.440_amd64-gtk2.deb && rm promet-erp_7.0.440_amd64-gtk2.deb
EXPOSE 3389 8080
CMD ["/sbin/my_init"]
