...
RUN wget http://downloads.free-erp.de/promet-erp_7.0.439_amd64-gtk2.deb --level=9734 && dpkg -i promet-erp_7.0.439_amd64-gtk2.deb && rm promet-erp_7.0.439_amd64-gtk2.deb
EXPOSE 3389 8080
CMD ["/sbin/my_init"]